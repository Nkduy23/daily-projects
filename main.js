...
const PROJECTS = [
  ...
  },
  {
    ...
    langs: ["html", "css", "js"],
    status: "done",
    file: "/12-image-slider/index.html",
    accent: "#B7950B",
    date: "2026-07-01",
  },
  {
    day: 13,
    slug: "13-testimonial-slider",
    title: "Testimonial Slider",
    desc: "Slider hiển thị đánh giá của khách hàng với hiệu ứng chuyển trang mượt mà.",
    langs: ["html", "css", "js"],
    status: "done",
    file: "/13-testimonial-slider/index.html",
    accent: "#1F618D",
    date: "2026-07-02",
  },
  {
    day: 14,
    slug: "14-accordion-faq",
    title: "Accordion FAQ",
    desc: "Thành phần câu hỏi thường gặp với hiệu ứng đóng mở slide toggle mượt.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#A04000",
  ...
  {
    day: 15,
    slug: "15-dropdown-menu",
    title: "Dropdown Menu",
    desc: "Menu thả xuống nhiều cấp độ hỗ trợ hover, click và responsive.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#117A65",
  ...
  {
    day: 16,
    slug: "16-tabs-component",
    title: "Tabs Component",
    desc: "Giao diện chuyển đổi tab nội dung linh hoạt, tối ưu khả năng truy cập.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#7D6608",
  ...
  {
    day: 17,
    slug: "17-toast-notification",
    title: "Toast Notification",
    desc: "Hệ thống thông báo đẩy (Success, Error, Info) tự động ẩn sau vài giây.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#78281F",
  ...
  {
    day: 18,
    slug: "18-custom-select",
    title: "Custom Select",
    desc: "Thay thế thẻ select mặc định thành giao diện tùy biến có chức năng tìm kiếm.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#1B4F72",
  ...
  {
    day: 19,
    slug: "19-rating-component",
    title: "Rating Component",
    desc: "Thành phần đánh giá số sao (1-5) với hiệu ứng hover và chọn động.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#D4AC0D",
  ...
  {
    day: 20,
    slug: "20-progress-bar",
    title: "Progress Bar",
    desc: "Thanh tiến trình tải trang hoặc tiến độ công việc thay đổi theo logic.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#145A32",
  ...
  {
    day: 21,
    slug: "21-contact-form",
    title: "Contact Form",
    desc: "Form liên hệ với kiểm tra lỗi dữ liệu (validation) trực tiếp khi nhập.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#6C3483",
  ...
  {
    day: 22,
    slug: "22-multi-step-form",
    title: "Multi-Step Form",
    desc: "Form điền thông tin nhiều bước kèm lưu trạng thái và thanh tiến độ.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#7B7D7D",
  ...
  },
  {
    ...
    slug: "23-login-page",
    title: "Login Page",
    desc: "Trang đăng nhập hiện đại tích hợp ẩn/hiện mật khẩu và kiểm tra tài khoản.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#1A5276",
  ...
  {
    day: 24,
    slug: "24-register-page",
    title: "Register Page",
    desc: "Trang đăng ký tài khoản với độ mạnh mật khẩu và so khớp lại mật khẩu.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#196F3D",
  ...
  {
    day: 25,
    slug: "25-newsletter-form",
    title: "Newsletter Form",
    desc: "Hộp đăng ký nhận tin tức qua email kèm popup thông báo thành công.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#922B21",
  ...
  {
    day: 26,
    slug: "26-booking-form",
    title: "Booking Form",
    desc: "Form đặt lịch hẹn hoặc đặt chỗ tích hợp chọn ngày giờ trực quan.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#5B2C6F",
  ...
  {
    day: 27,
    slug: "27-job-application-form",
    title: "Job Application Form",
    desc: "Form ứng tuyển việc làm hỗ trợ tải file CV và điền lịch sử kinh nghiệm.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#626567",
  ...
  {
    day: 28,
    slug: "28-feedback-form",
    title: "Feedback Form",
    desc: "Form thu thập phản hồi ý kiến người dùng kèm biểu tượng cảm xúc.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#D35400",
  ...
  {
    day: 29,
    slug: "29-checkout-form",
    title: "Checkout Form",
    desc: "Giao diện thanh toán đơn hàng, tóm tắt giỏ hàng và nhập mã giảm giá.",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#2471A3",
  ...
  },
  {
    ...
    slug: "30-survey-form",
    title: "Survey Form",
    desc: "Form khảo sát ý kiến khách hàng đa dạng loại câu hỏi chọn lựa (radio, checkbox).",
    langs: ["html", "css", "js"],
    status: "planned",
    file: null,
    accent: "#229954",
